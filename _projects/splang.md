...
description: "Final project for CS198-134"
...
| 0:03 | `JUMP`            | 1            | Jumps to the label defined by the next song's trackID.                                            |
| 0:04 | `JUMPZ`           | 1            | Jumps to the label defined by the next song's trackID if the top of the stack is 0.               |
| 0:05 | `JUMPNZ`          | 1            | Jumps to the label defined by the next song's trackID if the top of the stack is not 0.           |
| 0:06 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:07 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:08 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:09 | `Not_implemented` | None         | Not implemented.                                                                                  |
...
| 0:22 | `POP`             | None         | Pops the top element of the stack.                                                                |
| 0:23 | `DUP`             | None         | Duplicates the top element of the stack.                                                          |
| 0:24 | `SWAP`            | None         | Swaps the top two elements of the stack.                                                          |
| 0:25 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:26 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:27 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:28 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:29 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:30 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:31 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:32 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:33 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:34 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:35 | `Not_implemented` | None         | Not implemented.                                                                                  |
...
| 0:40 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:41 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:42 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:43 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:44 | `Not_implemented` | None         | Not implemented.                                                                                  |
...
| 0:50 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:51 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:52 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:53 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:54 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:55 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:56 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:57 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:58 | `Not_implemented` | None         | Not implemented.                                                                                  |
| 0:59 | `Not_implemented` | None         | Not implemented.                                                                                  |
